        ...
        <div class="row">
          ...
          <div class="col-md-9 text-center text-md-left">
            <div class="row">
              ...
              <div class="col-12">
                <p class="text-grey lato-light p">Black-Scholes-Merton implied volatilities are standard for quoting options prices. Differences across delta (smile or skew) and across time-to-expiration (term structure) provide ample fodder for investigating arbitrage and relative value opportunities.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-9 text-center text-md-left">
            <div class="row">
              ...
              <div class="col-12">
                <p class="text-grey lato-light p">Our data is the industry standard across academic and industry research that involves options data, from trading strategy research to corporate finance.<br/>Currently, over 300 institutional subscribers and universities rely on OptionMetrics.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-9 text-center text-md-left">
            <div class="row">
              ...
              <div class="col-12">
                <p class="text-grey lato-light p">Our products allow you to backtest trading strategies, evaluate risk models, and perform sophisticated research on all aspects of option investment.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-9 text-center text-md-left">
            <div class="row">
              ...
              <div class="col-12">
                <p class="text-grey lato-light">Our documentation explains exactly how our calculations work with enough detail to allow replication for spot checking. Additionally, all the raw data used is included with a subscription.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-9 text-center text-md-left">
            <div class="row">
              ...
              <div class="col-12">
                <p class="text-grey lato-light">We do not use input from market makers or brokers, and we are not affiliated with any bank, exchange or data vendor.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-9 text-center text-md-left">
            <div class="row">
              ...
              <div class="col-12">
                <p class="text-grey lato-light">Access is not tied to any particular API or tool. Users can choose to use an SQL server database and we include utilities to help set this up.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="row">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="carousel-item active text-center">
            ...
            <div class="partner-wrapper">
              ...
              <p class="text-blue montserrat-medium font-italic small">PRESIDENT AND FOUNDER</p>
    ...
    <div class="col-12 d-none d-lg-inline-block partner david px-5">
      ...
      <div class="partner-wrapper">
        ...
        <p class="text-blue montserrat-medium font-italic small pl-5">PRESIDENT AND FOUNDER</p>
    ...
    <div class="col-12 d-none partner robert px-5">
      ...
      <div class="partner-wrapper">
        <p class="text-blue montserrat-medium h5 pl-5">David J. Hait, Ph.D. ROBERT</p>
        <p class="text-blue montserrat-medium font-italic small pl-5">PRESIDENT AND FOUNDER</p>
        <p class="text-grey montserrat-light px-5">David J. Hait, Ph.D. is the President of OptionMetrics, LLC, which he founded in 1999. Dr. Hait is a financial economist with over 20 years of experience in applied quantitative derivative research and technology. Prior to founding OptionMetrics he served as Vice President in the Fixed Income Research Group at Paine Webber, and taught courses on derivatives at J. P. Morgan. Dr. Hait received his Ph.D. in Finance from New York University’s Stern School of Business, where he was an Adjunct Professor at the Stern School of Business and Courant Institute of Mathematics. Dr. Hait also received an MS in Computer Science from University of California at Berkeley and a BSE in Computer Engineering from the University of Pennsylvania.</p>
      </div>
    </div>
    <div class="col-12 d-none partner eran px-5">
      ...
      <div class="partner-wrapper">
        <p class="text-blue montserrat-medium h5 pl-5">David J. Hait, Ph.D. ERAN</p>
        <p class="text-blue montserrat-medium font-italic small pl-5">PRESIDENT AND FOUNDER</p>
        <p class="text-grey montserrat-light px-5">David J. Hait, Ph.D. is the President of OptionMetrics, LLC, which he founded in 1999. Dr. Hait is a financial economist with over 20 years of experience in applied quantitative derivative research and technology. Prior to founding OptionMetrics he served as Vice President in the Fixed Income Research Group at Paine Webber, and taught courses on derivatives at J. P. Morgan. Dr. Hait received his Ph.D. in Finance from New York University’s Stern School of Business, where he was an Adjunct Professor at the Stern School of Business and Courant Institute of Mathematics. Dr. Hait also received an MS in Computer Science from University of California at Berkeley and a BSE in Computer Engineering from the University of Pennsylvania.</p>
      </div>
    </div>
